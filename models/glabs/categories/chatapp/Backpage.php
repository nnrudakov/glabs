...
class Backpage extends BaseCategory
{
    ...
    protected function collectObjects($url)
    {
        ...
        if (false !== strpos($dom, 'No matches found')  || false !== strpos($dom, 'Keine Entsprechungen gefunden')  ||
            ...
            false !== strpos($dom, 'Eşleşme bulunamadı') || false !== strpos($dom, 'Eredmény nem található') ||
            false !== strpos($dom, 'Δεν βρέθηκαν εγγραφές') || false !== strpos($dom, 'Aucune correspondance n’a été trouvée')) {
            return true;
        }
